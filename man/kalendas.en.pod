...
The Julian date. The integer and decimal parts the 'C<fj>'
represent the Julian day number and Julian day fraction
respectively. With five numbers decimals the time is
obtained with precision of 1 second. 'C<fj>' can be a negative
number.
...
date calculations 'C<fj>' is a positive or negative real number.
View Examples.
...
C<kalendas>, version 1.0.0, $Date: 2013/09/12 23:20:35 $
